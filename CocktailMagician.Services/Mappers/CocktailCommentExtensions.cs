...
namespace CocktailMagician.Services.Mappers
{
    public static class CocktailCommentExtensions
    {
        ...
        public static ICollection<CocktailComment> GetEntities(this ICollection<CocktailCommentsDTO> cocktailComments)
        {
            return cocktailComments.Select(GetEntity).ToList();
        }
    }
}
